...
class SparkContext:
    ...
    # def binaryFiles(self, path: str, minPartitions: Optional[int] = None) -> otterbrix.experimental.spark.rdd.RDD[typing.Tuple[str, bytes]]:
    # 	pass

    # def binaryRecords(self, path: str, recordLength: int) -> otterbrix.experimental.spark.rdd.RDD[bytes]:
    # 	pass
    ...
    # def emptyRDD(self) -> otterbrix.experimental.spark.rdd.RDD[typing.Any]:
    # 	pass
    ...
    # def statusTracker(self) -> otterbrix.experimental.spark.status.StatusTracker:
    # 	raise ContributionsAcceptedError
