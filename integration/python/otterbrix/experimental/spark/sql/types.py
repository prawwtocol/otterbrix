...
class DataType:
    ...
    def __init__(self, otterbrix_type):
        self.otterbrix_type = otterbrix_type
...
class NullType(DataType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("NULL"))
...
class StringType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("VARCHAR"))
...
class BitstringType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("BIT"))
...
class UUIDType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("UUID"))
...
class BinaryType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("BLOB"))
...
class BooleanType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("BOOLEAN"))
...
class TimestampNTZType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("TIMESTAMP"))
...
class TimestampSecondNTZType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("TIMESTAMP_S"))
...
class TimestampMilisecondNTZType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("TIMESTAMP_MS"))
...
class TimestampNanosecondNTZType(AtomicType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("TIMESTAMP_NS"))
...
class DecimalType(FractionalType):
    ...
    def __init__(self, precision: int = 10, scale: int = 0):
        super().__init__(otterbrix.decimal_type(precision, scale))
...
class DoubleType(FractionalType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("DOUBLE"))
...
class FloatType(FractionalType, metaclass=DataTypeSingleton):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("FLOAT"))
...
class ByteType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("TINYINT"))
...
class UnsignedByteType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("UTINYINT"))
...
class ShortType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("SMALLINT"))
...
class UnsignedShortType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("USMALLINT"))
...
class IntegerType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("INTEGER"))
...
class UnsignedIntegerType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("UINTEGER"))
...
class LongType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("BIGINT"))
...
class UnsignedLongType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("UBIGINT"))
...
class HugeIntegerType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("HUGEINT"))
...
class UnsignedHugeIntegerType(IntegralType):
    ...
    def __init__(self):
        super().__init__(OtterBrixPyType("UHUGEINT"))
...
class ArrayType(DataType):
    ...
    def __init__(self, elementType: DataType, containsNull: bool = True):
        super().__init__(otterbrix.list_type(elementType.otterbrix_type))
...
class MapType(DataType):
    ...
    def __init__(self, keyType: DataType, valueType: DataType, valueContainsNull: bool = True):
        super().__init__(otterbrix.map_type(keyType.otterbrix_type, valueType.otterbrix_type))
...
class StructField(DataType):
    ...
    def __init__(
        ...
        super().__init__(dataType.otterbrix_type)
...
class StructType(DataType):
    ...
    def _update_internal_otterbrix_type(self):
        self.otterbrix_type = otterbrix.struct_type(dict(zip(self.names, [x.otterbrix_type for x in self.fields])))
    ...
    def __init__(self, fields: Optional[List[StructField]] = None):
        ...
        super().__init__(otterbrix.struct_type(dict(zip(self.names, [x.otterbrix_type for x in self.fields]))))
    ...
    def add(
        ...
        self._needConversion = [f.needConversion() for f in self]
        self._needSerializeAnyField = any(self._needConversion)
        self._update_internal_otterbrix_type()
        return self
